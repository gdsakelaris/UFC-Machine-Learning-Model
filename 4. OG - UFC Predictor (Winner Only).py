...
class ImprovedUFCPredictor:
    ...
    def swap_corners(self, df):
        ...
        interaction_features = [
            ...
            # NOTE: pressure_differential removed - contains "_diff" so auto-negated by pattern match (line 908)
        ]
    ...
    def fix_data_leakage(self, df):
        ...
        for idx, row in df.iterrows():
            ...
            for fighter, prefix in [(r_fighter, "r"), (b_fighter, "b")]:
                ...
                # Trajectory (weighted recent performance - newer fights weighted more)
                if len(stats["recent_wins"]) >= 3:
                    ...
                    df.at[idx, f"{prefix}_trajectory_3"] = 0
            ...
            if pd.notna(row["winner"]):
                ...
                # Track weight class history for both fighters
    ...
    def prepare_core_features(self, df):
        ...
        # NOTE: weight_comfort must be calculated in fix_data_leakage() for this to work
        ...
        # Finish momentum (coming off a finish AND win)
        ...
        # NOTE: opponent_quality_diff is calculated in fix_data_leakage() using chronological data
    ...
    def prepare_upcoming_fight(self, fight, feature_columns):
        ...
        # trajectory_3 calculated in fix_data_leakage()
        # ring_rust_factor calculated in prepare_core_features()
