    ...
    def fix_data_leakage(self, df):
        ...
        for idx, row in df.iterrows():
            ...
            for fighter, prefix in [(r_fighter, "r"), (b_fighter, "b")]:
                ...
                # Recent finish rate
                # Adaptive finish rate: use 10 fights if available, then 8, then 6, then 4, then 2
                ...
                # Adaptive recent form: use 10 fights if available, then 8, then 6, then 4, then 2
                ...
                # Adaptive window: use 10 fights if available, then 8, then 6, then 4, then 2
                if len(stats["recent_wins"]) >= 10:
