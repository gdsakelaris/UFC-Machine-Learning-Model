...
# Check for fight_data.csv in the same directory as the script
...
class AdvancedUFCPredictor:
    ...
    def __init__(self, use_ensemble=True, use_neural_net=False, use_deep_learning=False):
    ...
    def predict_fight(self, fight_data, feature_columns):
        ...
        # COMPREHENSIVE METHOD PREDICTION
        ...
        # Combine model predictions with comprehensive adjustments
        final_method_probs = {}
        for i, label in enumerate(method_labels):
            if label.startswith(winner_name):
                ...
                # Weighted combination: 40% model, 60% comprehensive adjustments
                final_prob = base_prob * 0.4 + adjustment_prob * 0.6
...
try:
    # Only run if this is the main module and not being imported
    if __name__ == "__main__":
        main()
    elif __name__ == "__main__" or __name__ == "UFC Predictor":
        # Additional check for IDE execution
        main()
except Exception as e:
